...
let s:p.normal.left = [[s:base15, s:base5, 'bold'], [s:base0, s:base8]]
let s:p.insert.left = [[s:base15, s:base4, 'bold'], [s:base0, s:base8]]
let s:p.replace.left = [[s:base15, s:base1, 'bold'], [s:base0, s:base8]]
let s:p.visual.left = [[s:base15, s:base3, 'bold'], [s:base0, s:base8]]
